...
import { mockProducts, categories, statusOptions, inventoryOptions } from './mockData';
...
const CatalogTable: React.FC = () => {
  ...
  }, [searchTerm, selectedCategory, selectedStatus, selectedInventory]);
    ...
    <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg border border-[rgb(var(--c-neutral-200))] p-4">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <button
            disabled
            className="flex items-center gap-2 px-4 py-2 border border-[rgb(var(--c-neutral-300))] rounded-lg text-sm text-[rgb(var(--c-neutral-400))] bg-gray-50 cursor-not-allowed"
          >
      ...
      <div className="bg-white rounded-lg border border-[rgb(var(--c-neutral-200))] overflow-hidden">
        ...
        {!isLoading && filteredProducts.length > 0 && (
          <div className="px-4 py-3 border-t border-[rgb(var(--c-neutral-200))] flex items-center justify-between">
      ...
      <div className="lg:hidden space-y-4">
        {filteredProducts.map((product) => (
          <div
            key={product.id}
            className="bg-white rounded-lg border border-[rgb(var(--c-neutral-200))] p-4 space-y-3"
          >
